...
// This file is autogenerated using generate_can_messages.py from the DBC
// definitions in can_dbc.py
...
struct Get_Version_msg_t final {
  ...
  Get_Version_msg_t(const TBoard::TCanIntf::TMsg &msg) { decode_msg(msg); }
...
#ifdef ODRIVE_CAN_MSG_TYPE
  Heartbeat_msg_t(const TBoard::TCanIntf::TMsg &msg) { decode_msg(msg); }
...
#ifdef ODRIVE_CAN_MSG_TYPE
  Estop_msg_t(const TBoard::TCanIntf::TMsg &msg) { decode_msg(msg); }
...
#ifdef ODRIVE_CAN_MSG_TYPE
  Get_Error_msg_t(const TBoard::TCanIntf::TMsg &msg) { decode_msg(msg); }
...
#ifdef ODRIVE_CAN_MSG_TYPE
  Address_msg_t(const TBoard::TCanIntf::TMsg &msg) { decode_msg(msg); }
...
#ifdef ODRIVE_CAN_MSG_TYPE
  Set_Axis_State_msg_t(const TBoard::TCanIntf::TMsg &msg) { decode_msg(msg); }
...
#ifdef ODRIVE_CAN_MSG_TYPE
  Set_Input_Pos_msg_t(const TBoard::TCanIntf::TMsg &msg) { decode_msg(msg); }
...
#ifdef ODRIVE_CAN_MSG_TYPE
  Set_Input_Vel_msg_t(const TBoard::TCanIntf::TMsg &msg) { decode_msg(msg); }
...
#ifdef ODRIVE_CAN_MSG_TYPE
  Set_Input_Torque_msg_t(const TBoard::TCanIntf::TMsg &msg) { decode_msg(msg); }
...
#ifdef ODRIVE_CAN_MSG_TYPE
  Set_Limits_msg_t(const TBoard::TCanIntf::TMsg &msg) { decode_msg(msg); }
...
#ifdef ODRIVE_CAN_MSG_TYPE
  Set_Traj_Inertia_msg_t(const TBoard::TCanIntf::TMsg &msg) { decode_msg(msg); }
...
#ifdef ODRIVE_CAN_MSG_TYPE
  Get_Iq_msg_t(const TBoard::TCanIntf::TMsg &msg) { decode_msg(msg); }
...
#ifdef ODRIVE_CAN_MSG_TYPE
  Get_Temperature_msg_t(const TBoard::TCanIntf::TMsg &msg) { decode_msg(msg); }
...
#ifdef ODRIVE_CAN_MSG_TYPE
  Reboot_msg_t(const TBoard::TCanIntf::TMsg &msg) { decode_msg(msg); }
...
#ifdef ODRIVE_CAN_MSG_TYPE
  Clear_Errors_msg_t(const TBoard::TCanIntf::TMsg &msg) { decode_msg(msg); }
...
#ifdef ODRIVE_CAN_MSG_TYPE
  Set_Pos_Gain_msg_t(const TBoard::TCanIntf::TMsg &msg) { decode_msg(msg); }
...
#ifdef ODRIVE_CAN_MSG_TYPE
  Set_Vel_Gains_msg_t(const TBoard::TCanIntf::TMsg &msg) { decode_msg(msg); }
...
#ifdef ODRIVE_CAN_MSG_TYPE
  Get_Torques_msg_t(const TBoard::TCanIntf::TMsg &msg) { decode_msg(msg); }
...
#ifdef ODRIVE_CAN_MSG_TYPE
  Get_Powers_msg_t(const TBoard::TCanIntf::TMsg &msg) { decode_msg(msg); }
...
#ifdef ODRIVE_CAN_MSG_TYPE
  Enter_DFU_Mode_msg_t(const TBoard::TCanIntf::TMsg &msg) { decode_msg(msg); }
