...
//
// Each instance of VectorAtPositionVisual represents the visualization of a
// single sensor_msgs::VectorAtPosition message. Currently it just shows an
...
class VectorAtPositionVisual {
 ...
 protected:
  ...
  // Store the scaling factor and the length of the vector, so that it can be
  // scale afterwards
  float length_;
