...
TEST(TfConventionTest, Concatenation) {
  kindr::ConventionTest<tf2::Quaternion, tf2::Vector3,
                        double>::testConcatenation();
  kindr::ConventionTest<tf2::Matrix3x3, tf2::Vector3,
                        double>::testConcatenation();
}

TEST(TfConventionTest, Rotation) {
  kindr::ConventionTest<tf2::Quaternion, tf2::Vector3,
                        double>::testRotationMatrix();
  kindr::ConventionTest<tf2::Matrix3x3, tf2::Vector3,
                        double>::testRotationMatrix();
}
...
TEST(TfConventionTest, GeometricalInterpretation) {
  kindr::ConventionTest<tf2::Quaternion, tf2::Vector3,
                        double>::testGeometricalInterpretation();
  kindr::ConventionTest<tf2::Matrix3x3, tf2::Vector3,
                        double>::testGeometricalInterpretation();
}
