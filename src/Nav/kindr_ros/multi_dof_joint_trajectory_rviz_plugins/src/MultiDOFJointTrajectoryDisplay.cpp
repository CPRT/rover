...
MultiDOFJointTrajectoryDisplay::MultiDOFJointTrajectoryDisplay()
  ...
  property_show_connection_ =
      new rviz::BoolProperty("Show Connections", show_connection_,
                             "Enable or disable connections rendering.", this,
                             SLOT(setShowConnection()));

  property_show_transform_rotation_ = new rviz::BoolProperty(
      "Show Transform Rotation", show_transform_rotation_,
      "Enable or disable rotation transforms rendering.", this,
      SLOT(setShowTransformRotation()));

  property_show_velocity_linear_ =
      new rviz::BoolProperty("Show Velocity Linear", show_velocity_linear_,
                             "Enable or disable linear velocities rendering.",
                             this, SLOT(setShowVelocityLinear()));

  property_show_velocity_angular_ =
      new rviz::BoolProperty("Show Velocity Angular", show_velocity_angular_,
  ...
  property_show_acceleration_linear_ = new rviz::BoolProperty(
      ...
      "Enable or disable linear accelerations rendering.", this,
      SLOT(setShowAccelerationLinear()));

  property_show_acceleration_angular_ = new rviz::BoolProperty(
      "Show Acceleration Angular", show_acceleration_angular_,
      "Enable or disable angular accelerations rendering.", this,
      SLOT(setShowAccelerationAngular()));
  ...
  property_size_transform_rotation_ = new rviz::FloatProperty(
      ...
      SLOT(setSizeTransformRotation()));
  property_size_transform_rotation_->setMin(0);

  property_diameter_arrows_ = new rviz::FloatProperty(
      "Diameter Arrows", diameter_arrows_, "Diameter of the arrows.", this,
      SLOT(setDiameterArrows()));
  ...
  property_scale_velocity_linear_ = new rviz::FloatProperty(
      ...
      "Scale of the linear velocities.", this, SLOT(setScaleVelocityLinear()));

  property_scale_velocity_angular_ =
      new rviz::FloatProperty("Scale Velocity Angular", scale_velocity_angular_,
                              "Scale of the angular velocities.", this,
                              SLOT(setScaleVelocityAngular()));

  property_scale_acceleration_linear_ = new rviz::FloatProperty(
      "Scale Acceleration Linear", scale_acceleration_linear_,
      "Scale of the linear accelerations.", this,
      SLOT(setScaleAccelerationLinear()));

  property_scale_acceleration_angular_ = new rviz::FloatProperty(
      "Scale Acceleration Angular", scale_acceleration_angular_,
      "Scale of the angular accelerations.", this,
      SLOT(setScaleAccelerationAngular()));

  property_color_connection_ = new rviz::ColorProperty(
      "Color Connection", rviz::ogreToQt(color_connection_),
      "Color of connection lines.", this, SLOT(setColorConnection()));

  property_color_velocity_linear_ = new rviz::ColorProperty(
      "Color Velocity Linear", rviz::ogreToQt(color_velocity_linear_),
      "Color of the linear velocities.", this, SLOT(setColorVelocityLinear()));

  property_color_velocity_angular_ = new rviz::ColorProperty(
      "Color Velocity Angular", rviz::ogreToQt(color_velocity_angular_),
      "Color of the angular velocities.", this,
      SLOT(setColorVelocityAngular()));
  ...
  property_color_acceleration_linear_ = new rviz::ColorProperty(
      ...
      "Color of the linear accelerations.", this,
      SLOT(setColorAccelerationLinear()));
...
void MultiDOFJointTrajectoryDisplay::setScaleAccelerationAngular() {
  scale_acceleration_angular_ =
      property_scale_acceleration_angular_->getFloat();
...
void MultiDOFJointTrajectoryDisplay::setColorVelocityLinear() {
  color_velocity_linear_ =
      rviz::qtToOgre(property_color_velocity_linear_->getColor());
...
void MultiDOFJointTrajectoryDisplay::setColorVelocityAngular() {
  color_velocity_angular_ =
      rviz::qtToOgre(property_color_velocity_angular_->getColor());
...
void MultiDOFJointTrajectoryDisplay::setColorAccelerationLinear() {
  color_acceleration_linear_ =
      rviz::qtToOgre(property_color_acceleration_linear_->getColor());
...
void MultiDOFJointTrajectoryDisplay::setColorAccelerationAngular() {
  color_acceleration_angular_ =
      rviz::qtToOgre(property_color_acceleration_angular_->getColor());
...
void MultiDOFJointTrajectoryDisplay::updateTrajectory() {
  ...
  for (unsigned int i = 0; i < current_trajectory_->points.size(); i++) {
    ...
    for (unsigned int j = 0; j < current_trajectory_->joint_names.size(); j++) {
      std::stringstream ss;
      ss << current_trajectory_->joint_names[j] << ": t" << i << " = "
         << current_trajectory_->points[i].time_from_start.toSec() << "s";
  ...
  std::vector<boost::shared_ptr<MultiDOFJointTrajectoryPointVisual>>
      visuals_points;
  std::vector<boost::shared_ptr<MultiDOFJointTrajectoryPointConnectionVisual>>
      visuals_connections;

  trajectory_msgs::MultiDOFJointTrajectoryPoint last_point;
  trajectory_msgs::MultiDOFJointTrajectoryPoint current_point =
      current_trajectory_->points[0];

  // add first point
  visuals_points.push_back(
      boost::shared_ptr<MultiDOFJointTrajectoryPointVisual>(
          new MultiDOFJointTrajectoryPointVisual(
              context_->getSceneManager(), scene_node_, current_point,
              show_transform_rotation_, show_velocity_linear_,
              show_velocity_angular_, show_acceleration_linear_,
              show_acceleration_angular_, size_transform_rotation_,
              diameter_arrows_, scale_velocity_linear_, scale_velocity_angular_,
              scale_acceleration_linear_, scale_acceleration_angular_, alpha_,
              color_velocity_linear_, color_velocity_angular_,
              color_acceleration_linear_, color_acceleration_angular_,
              captions[0], font_size_, show_text_)));
  ...
  for (unsigned int i = 1; i < current_trajectory_->points.size(); i++) {
    ...
    visuals_connections.push_back(
        boost::shared_ptr<MultiDOFJointTrajectoryPointConnectionVisual>(
            new MultiDOFJointTrajectoryPointConnectionVisual(
                context_->getSceneManager(), scene_node_, last_point,
                current_point, show_connection_, color_connection_)));
    ...
    visuals_points.push_back(
        boost::shared_ptr<MultiDOFJointTrajectoryPointVisual>(
            new MultiDOFJointTrajectoryPointVisual(
                ...
                show_velocity_angular_, show_acceleration_linear_,
                show_acceleration_angular_, size_transform_rotation_,
                diameter_arrows_, scale_velocity_linear_,
                scale_velocity_angular_, scale_acceleration_linear_,
                scale_acceleration_angular_, alpha_, color_velocity_linear_,
                color_velocity_angular_, color_acceleration_linear_,
                color_acceleration_angular_, captions[i], font_size_,
                show_text_)));
  }
...
void MultiDOFJointTrajectoryDisplay::updateShowAccelerationLinear() {
  for (size_t i = 0; i < visuals_points_.size(); i++) {
    for (unsigned int j = 0; j < visuals_points_[i].size(); j++) {
      visuals_points_[i][j]->setShowAccelerationLinear(
...
void MultiDOFJointTrajectoryDisplay::updateShowAccelerationAngular() {
  for (size_t i = 0; i < visuals_points_.size(); i++) {
    for (unsigned int j = 0; j < visuals_points_[i].size(); j++) {
      visuals_points_[i][j]->setShowAccelerationAngular(
...
void MultiDOFJointTrajectoryDisplay::updateScaleAccelerationLinear() {
  for (size_t i = 0; i < visuals_points_.size(); i++) {
    for (unsigned int j = 0; j < visuals_points_[i].size(); j++) {
      visuals_points_[i][j]->setScaleAccelerationLinear(
...
void MultiDOFJointTrajectoryDisplay::updateScaleAccelerationAngular() {
  for (size_t i = 0; i < visuals_points_.size(); i++) {
    for (unsigned int j = 0; j < visuals_points_[i].size(); j++) {
      visuals_points_[i][j]->setScaleAccelerationAngular(
          scale_acceleration_angular_);
    }
  }
}
...
void MultiDOFJointTrajectoryDisplay::updateColorAccelerationLinear() {
  for (size_t i = 0; i < visuals_points_.size(); i++) {
    for (unsigned int j = 0; j < visuals_points_[i].size(); j++) {
      visuals_points_[i][j]->setColorAccelerationLinear(
          color_acceleration_linear_);
    }
  }
}
...
void MultiDOFJointTrajectoryDisplay::updateColorAccelerationAngular() {
  for (size_t i = 0; i < visuals_points_.size(); i++) {
    for (unsigned int j = 0; j < visuals_points_[i].size(); j++) {
      visuals_points_[i][j]->setColorAccelerationAngular(
          color_acceleration_angular_);
    }
  }
}
...
PLUGINLIB_EXPORT_CLASS(
    multi_dof_joint_trajectory_rviz_plugins::MultiDOFJointTrajectoryDisplay,
    rviz::Display)
