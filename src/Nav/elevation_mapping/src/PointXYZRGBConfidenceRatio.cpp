 ...
 *
 *   This file contains explicit definitions of algorithms used with our custom
 * pcl type.
 */
...
template class pcl::PCLBase<
    pcl::
        PointXYZRGBConfidenceRatio>;  // NOLINT(cppcoreguidelines-special-member-functions)
template class pcl::VoxelGrid<
    pcl::
        PointXYZRGBConfidenceRatio>;  // NOLINT(cppcoreguidelines-special-member-functions)
...
std::ostream& operator<<(std::ostream& os,
                         const pcl::PointXYZRGBConfidenceRatio& p) {
  os << "(" << p.x << "," << p.y << "," << p.z << " - " << static_cast<int>(p.r)
     << ","  // NOLINT(cppcoreguidelines-pro-type-union-access)
     << static_cast<int>(
            p.g)  // NOLINT(cppcoreguidelines-pro-type-union-access)
     << ","       // NOLINT(cppcoreguidelines-pro-type-union-access)
